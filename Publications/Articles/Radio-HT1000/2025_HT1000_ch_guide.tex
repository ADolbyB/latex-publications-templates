...
\medskip
This is a guide to help understand various radio functions and help explain some useful, often overlooked 
features of the Motorola HT1000s. The actual manual that is screenshot on the next page is a free downloadable 
PDF that is available on \textit{The Internet Archive}. There is a link to this manual as well
...
174 MHz is used for broadcast television. This is why we are allowed to use an FCC Part 90 radio in the 
MURS band: the two sets of rules (Part 90 and Part 95) have overlap and the Part 90 operator license exceeds 
any license class in the entire FCC Part 95 regulations.
