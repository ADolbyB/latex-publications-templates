...
\begin{itemize}
    ...
    \item The abbreviation ``Hz'' for Hertz is used, which is a measurement of frequency. Hz means ``cycles per second,'' 
        which is to say how many times one radio wave cycle or period repeats itself per second. Also note:
        \begin{itemize}
...
FCC Part 95 regulations, given that we can operate within the FCC's frequency, bandwidth and power allocations.
...
% === Page 18 ========================================================================    
    ...
    \item \textit{FCC Part 73}: These are the FCC regulations and spectrum allocation for all broadcast services, 
        including AM/FM radio and over the air broadcast television.
