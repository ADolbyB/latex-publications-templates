...
dispatcher when one of the officers (or firefighters or EMS, etc.) calls out on the radio. The dispatcher knows 
...
allowed because the beacon is a \textit{broadcast station}.
...
% === Page 18 ========================================================================    
    \item \textit{The Electromagnetic Spectrum}: This is the entire spectrum of frequencies in the universe. It
        ...
        picture. Just above visible light are Ultraviolet rays or UV Light, which we also can't see. At the very high
