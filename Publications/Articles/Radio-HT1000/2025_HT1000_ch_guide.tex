...
\begin{itemize}
    ...
    \begin{itemize}
        \item This is what the \textsc{Engineer} or \textsc{Technician} uses to identify electrical circuit 
            ...
            This is a very effective method of testing if there are more than 1 of the same assembly. This client was 
            given 4 HT1000s, so if one breaks, any radio repair facility can take one good unit and one broken unit, 
...
\item \href{https://www.altium.com/altium-designer}{Altium Designer}
    \begin{itemize}
        ...
        \item This is the software we all used at the OEM in South Florida. This author used all the diagrams to fix 
        the \textit{embedded computer systems} we manufactured at the OEM.
    \end{itemize}
...
\end{center}
    ...
    \item \textit{Jedi Series}: The Motorola Jedi Series is a generation of radios that were in use in the 1990s
        ...
        HT600s), and proceeded by the ''Astro'' series (Astro Spectras and XTS3000s), and then replaced by the 
        ``Astro25'' series of radios (XTS and XTL 5000s).
